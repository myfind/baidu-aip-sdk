...
class Ocr extends Api
{
     ...
     */
    const generalBasicUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic';

    /**
     * 通用文字识别（高精度版） accurate_basic api url
     */
    const accurateBasicUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/accurate_basic';
     ...
     */
    const generalEnhancedUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/general_enhanced';
     ...
     */
    const tableRecognizeUrl = 'https://aip.baidubce.com/rest/2.0/solution/v1/form_ocr/request';

    /**
     * 表格识别结果 table_result_get api url
     */
    const tableResultGetUrl = 'https://aip.baidubce.com/rest/2.0/solution/v1/form_ocr/get_request_result';
     ...
     */
    const numbersUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/numbers';
     ...
     */
    const customUrl = 'https://aip.baidubce.com/rest/2.0/solution/v1/iocr/recognise';
    ...
    public function basicGeneral($image, $options = [])
    {
        ...
        return $this->post(Ocr::generalBasicUrl, $data);
    }
    ...
    public function basicAccurate($image, $options = [])
    {
        ...
        return $this->post(Ocr::accurateBasicUrl, $data);
    }
    ...
    public function general($image, $options = [])
    {
        ...
        return $this->post(Ocr::generalUrl, $data);
    }
    ...
    public function accurate($image, $options = [])
    {
        ...
        return $this->post(Ocr::accurateUrl, $data);
    }
    ...
    public function enhancedGeneral($image, $options = [])
    {
        ...
        return $this->post(Ocr::generalEnhancedUrl, $data);
    }
    ...
    public function webImage($image, $options = [])
    {
        ...
        return $this->post(Ocr::webImageUrl, $data);
    }
    ...
    public function idcard($image, $idCardSide, $options = [])
    {
        ...
        return $this->post(Ocr::idcardUrl, $data);
    }
    ...
    public function bankcard($image, $options = [])
    {
        ...
        return $this->post(Ocr::bankcardUrl, $data);
    }
    ...
    public function drivingLicense($image, $options = [])
    {
        ...
        return $this->post(Ocr::drivingLicenseUrl, $data);
    }
    ...
    public function vehicleLicense($image, $options = [])
    {
        ...
        return $this->post(Ocr::vehicleLicenseUrl, $data);
    }
    ...
    public function licensePlate($image, $options = [])
    {
        ...
        return $this->post(Ocr::licensePlateUrl, $data);
    }
    ...
    public function businessLicense($image, $options = [])
    {
        ...
        return $this->post(Ocr::businessLicenseUrl, $data);
    }
    ...
    public function receipt($image, $options = [])
    {
        ...
        return $this->post(Ocr::receiptUrl, $data);
    }
    ...
    public function form($image, $options = [])
    {
        ...
        return $this->post(Ocr::formUrl, $data);
    }
    ...
    public function tableRecognitionAsync($image, $options = [])
    {
        ...
        return $this->post(Ocr::tableRecognizeUrl, $data);
    }
    ...
    public function getTableRecognitionResult($requestId, $options = [])
    {
        ...
        return $this->post(Ocr::tableResultGetUrl, $data);
    }
    ...
    public function vatInvoice($image, $options = [])
    {
        ...
        return $this->post(Ocr::vatInvoiceUrl, $data);
    }
    ...
    public function qrcode($image, $options = [])
    {
        ...
        return $this->post(Ocr::qrcodeUrl, $data);
    }
    ...
    public function numbers($image, $options = [])
    {
        ...
        return $this->post(Ocr::numbersUrl, $data);
    }
    ...
    public function lottery($image, $options = [])
    {
        ...
        return $this->post(Ocr::lotteryUrl, $data);
    }
    ...
    public function passport($image, $options = [])
    {
        ...
        return $this->post(Ocr::passportUrl, $data);
    }
    ...
    public function businessCard($image, $options = [])
    {
        ...
        return $this->post(Ocr::businessCardUrl, $data);
    }
    ...
    public function handwriting($image, $options = [])
    {
        ...
        return $this->post(Ocr::handwritingUrl, $data);
    }
    ...
    public function custom($image, $templateSign, $options = [])
    {
        ...
        return $this->post(Ocr::customUrl, $data);
    }
